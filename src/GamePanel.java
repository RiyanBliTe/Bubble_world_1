...
public class GamePanel extends JPanel implements Runnable
{
	...
	public GamePanel() 
	{
        ...
        setFocusable(true);
        requestFocus();
        addKeyListener(new Listreners());
        addMouseMotionListener(new Listreners());
        addMouseListener(new Listreners());
     }
...
URDTimeMillis = (System.nanoTime() - startTime)/1000000;
	...
	private void gameRender() 
	{
		...
		g.drawString("Lvl: "+ Wave.waveNumber, 0, 13);
		g.drawString("Weapon lvl: " +player.getPower()+" / "+player.getMaxPowerLevel(), 0, 26);
		...
		g.setColor(Color.WHITE);
		g.drawString("Lives: "+ player.getLives(), 0, 42);
